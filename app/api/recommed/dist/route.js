...
function POST(req) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var data, prompt, response, resultStr, result, err_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    response = _b.sent();
                    resultStr = ((_a = response.choices[0].message) === null || _a === void 0 ? void 0 : _a.content) || "{}";
                    result = void 0;
                    try {
                ...
                case 3:
                    err_1 = _b.sent();
                    console.error("API route error:", err_1);
