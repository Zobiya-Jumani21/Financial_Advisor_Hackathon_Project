  ...
  useEffect(() => {
    const fetchPortfolio = async () => {
      try {
        ...
        // Get the latest portfolio for this user
        ...
        const latestData = snapshot.docs[0].data() as FormData
        const recommendations = generateInvestmentRecommendations(latestData)
        ...
        <section className="bg-gradient-to-br from-primary/10 via-background to-secondary/10 py-12">
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
              ...
              <Card className="text-center">
                <CardContent className="p-6">
                  <Badge variant="secondary" className="text-base px-3 py-1">{portfolio.riskProfile}</Badge>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-12">
                ...
                <p className="text-muted-foreground text-balance">Here's how your investment will be distributed across different asset classes.</p>
              </div>
                    ...
                    <div key={rec.id} className="flex items-center justify-between p-4 rounded-lg border">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          ...
                          <div className="text-sm text-muted-foreground">Expected: {rec.expectedReturn}</div>
                        </div>
                      </div>
                      <div className="text-right">
                        <div className="font-bold text-lg">{rec.percentage}%</div>
                        <div className="text-sm text-muted-foreground">PKR {rec.amount.toLocaleString()}</div>
                      </div>
                    </div>
                  ))}
                </div>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-12">
                ...
                <p className="text-muted-foreground text-balance">Detailed analysis of each recommended investment category.</p>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                {portfolio.recommendations.map((rec) => (
                  <InvestmentCard key={rec.id} recommendation={rec} />
                ))}
              </div>
            </div>
          </div>
        ...
        <section className="py-16">
          <div className="container mx-auto px-4 text-center">
            <div className="max-w-2xl mx-auto">
              ...
              <p className="text-muted-foreground text-balance mb-8">Want to try different parameters or update your investment amount? You can recalculate your portfolio anytime.</p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button size="lg" onClick={handleRecalculate} className="text-base">Recalculate Portfolio</Button>
                <Button size="lg" variant="outline" className="text-base bg-transparent" disabled>Download Report (Coming Soon)</Button>
              </div>
            </div>
          </div>
        </section>
